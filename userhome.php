...
<a href="" style="font-size:20pt; color:#ffffff;"></a>
    <a href="requestjob.php" style="font-size:20pt; color:#ffffff;">RequestJob</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  ...
  <li class="dropdown">
    <a href="#" style="font-size:20pt; padding:3px; color:#ffffff;">Edit</a>
    ...
    <div class="dropdown-content">
	  ...
	  <a href="editpass.php" style="font-size:15pt;">Password</a><br>
      <a href="editpro.php" style="font-size:15pt;">Profile</a><br>
     </div>
  </li>
  
  
  <li class="dropdown">
    <a href="#" style="font-size:20pt; padding:3px; color:#ffffff;">View</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	
	
	
	
    <div class="dropdown-content">
	  <a href="userpro.php" style="font-size:15pt;">Profile</a><br>

	  <a href="usernotification.php" style="font-size:15pt;">Notification</a><br>
      <a href="viewjobstatus.php" style="font-size:15pt;">Job Status</a><br>
	        <a href="viewjobschedule.php" style="font-size:15pt;">Job Schedule</a><br>
